...
export class PsicologoComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-psicologo div table .btn-danger'));
  title = element.all(by.css('jhi-psicologo div h2#page-heading span')).first();
...
export class PsicologoUpdatePage {
  pageTitle = element(by.id('jhi-psicologo-heading'));
...
export class PsicologoDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-psicologo-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-psicologo'));
