...
export class EnfermeiroComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-enfermeiro div table .btn-danger'));
  title = element.all(by.css('jhi-enfermeiro div h2#page-heading span')).first();
...
export class EnfermeiroUpdatePage {
  pageTitle = element(by.id('jhi-enfermeiro-heading'));
...
export class EnfermeiroDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-enfermeiro-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-enfermeiro'));
