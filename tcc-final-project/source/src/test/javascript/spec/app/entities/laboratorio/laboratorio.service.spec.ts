...
describe('Service Tests', () => {
  describe('Laboratorio Service', () => {
    ...
    let expectedResult: ILaboratorio | ILaboratorio[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Laboratorio(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', TipoUnidadeSaude.PUBLICA);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Laboratorio', () => {
        ...
        service.create(new Laboratorio()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a Laboratorio', () => {
        const returnedFromService = Object.assign(
          {
            cNPJ: 'BBBBBB',
            telefone: 'BBBBBB',
      ...
      it('should return a list of Laboratorio', () => {
        const returnedFromService = Object.assign(
          {
            cNPJ: 'BBBBBB',
            telefone: 'BBBBBB',
