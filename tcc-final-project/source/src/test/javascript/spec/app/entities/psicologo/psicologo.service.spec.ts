...
describe('Service Tests', () => {
  describe('Psicologo Service', () => {
    ...
    let elemDefault: IPsicologo;
    let expectedResult: IPsicologo | IPsicologo[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a Psicologo', () => {
        ...
        service.create(new Psicologo()).subscribe(resp => (expectedResult = resp.body));
