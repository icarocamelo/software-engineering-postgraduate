...
public class Fisioterapeuta implements Serializable {
    ...
    public Fisioterapeuta nome(String nome) {
        this.nome = nome;
        return this;
    }
    ...
    public Fisioterapeuta rG(String rG) {
        this.rG = rG;
        return this;
    }
    ...
    public Fisioterapeuta cPF(String cPF) {
        this.cPF = cPF;
        return this;
    }
    ...
    public Fisioterapeuta numeroRegistro(String numeroRegistro) {
    ...
    public Fisioterapeuta agenda(Set<Agenda> agenda) {
        this.agenda = agenda;
        return this;
    }

    public Fisioterapeuta addAgenda(Agenda agenda) {
        this.agenda.add(agenda);
        agenda.setFisioterapeuta(this);
        return this;
    }

    public Fisioterapeuta removeAgenda(Agenda agenda) {
        this.agenda.remove(agenda);
        agenda.setFisioterapeuta(null);
        return this;
    }
